...
class Staff extends BaseController
{
        ...
        if ($this->request->getMethod() === 'post' && $this->validate(
            ...
            if (! empty($_FILES['gambar']['name'])) {
                ...
                $data = ['id_user'      => $this->session->get('id_user'),
                    ...
                    'tanggal_post' => date('Y-m-d H:i:s', now()),
                ];
                $m_staff->tambah($data);
                // masuk database
    ...
    public function edit($id_staff)
    {
        ...
        if (empty($staff)) {
            return redirect()->to(base_url('admin/staff'))->with('error', 'Data staff tidak ditemukan');
        }

        // Get kategori staff list
        $kategori_staff = $m_kategori_staff->listing();
        ...
        if ($this->request->getMethod() === 'post') {
            ...
            if ($this->validate($validationRules)) {
                ...
                $data = [
                    'id_staff' => $id_staff, // tambahkan inisialisasi id_staff
