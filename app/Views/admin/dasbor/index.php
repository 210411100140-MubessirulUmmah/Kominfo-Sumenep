...
<div class="alert alert-info">
	...
	<hr>
	<p>Selamat datang di website <strong><?= namaweb() ?></strong>. Website ini adalah layanan informasi satuan polisi pamong praja Kabupaten Sumenep <a href="https://satpolppsumenep.com">www.satpolppsumenep.com</a>. Semoga bermanfaat yah.</p>
</div>
  ...
  <div class="col-12 col-sm-6 col-md-3">
    <div class="info-box mb-3">
      ...
      <div class="info-box-content">
        ...
        <span class="info-box-number"><?= angka($m_dasbor->ulasan()) ?></span>
      </div>
      <!-- /.info-box-content -->
    </div>
    <!-- /.info-box -->
...
<!-- /.col -->
  <div class="col-12 col-sm-6 col-md-3">
    <div class="info-box mb-3">
      ...
      <div class="info-box-content">
        <span class="info-box-text">Bank Data</span>
        <span class="info-box-number"><?= angka($m_dasbor->bankdata()) ?></span>
      </div>
      <!-- /.info-box-content -->
    </div>
    <!-- /.info-box -->
