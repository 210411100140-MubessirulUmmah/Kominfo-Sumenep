    ...
    <div class="form-group row">
        ...
        <div class="col-3">
            <select name="id_kategori_staff" class="form-control">
                <?php foreach ($kategori_staff as $kategori) { ?>
                    <option value="<?= $kategori['id_kategori_staff'] ?>" <?php if ($staff['id_kategori_staff'] === $kategori['id_kategori_staff']) echo 'selected'; ?>>
        ...
        <div class="col-3">
            <select name="status_staff" class="form-control">
                <option value="Publish" <?php if ($staff['status_staff'] === 'Publish') echo 'selected'; ?>>Publish</option>
